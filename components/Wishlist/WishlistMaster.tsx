...
const WishlistMaster = () => {
  ...
  const handleAddCart = async (
    ...
    if (min_qty <= productCountsQty) {
      ...
      const addListMessage = await AddToCartApi(addCartData, currency_state_from_redux?.selected_currency_value);
          ...
          <div className="container wishlist-container">
            {wishlistCount > 0 ? (
              <>
                ...
                <div className="row mt-5 mx-4 wishlist-header">
                  <h5 className="col-lg-5 col-md-4 d-none d-md-block text-white wishlist-heading">
                    Product
                  </h5>
                  <h5 className="col-lg-2 col-md-2 col-3 d-none d-md-block text-white wishlist-heading">
                    Price
                  </h5>
                  <h5 className="col-lg-2 col-md-2 col-3 d-none d-md-block text-white wishlist-heading">
                    Quantity
                  </h5>
                  <h5 className="col-lg-3 col-md-2 col-3 d-none d-md-block text-white wishlist-heading">
                    Actions
                  </h5>
                </div>
                    ...
                    <div className="row " key={index}>
                            ...
                            <input
                              ...
                              className={`${
                                ...
                                productCounts[index] === item?.min_order_qty
                                  ? "text-danger"
                                  : ""
                              } w-100 ml-2 text-center input-qty`}
                              onChange={(e: any) =>
                      ...
                      <div className="col-lg-3 col-md-3 ">
                        <div className="d-lg-flex">
                          <button
                            className="ml-1 text-white btn btn-dark px-3 mt-lg-0 mt-md-2 add-to-cart"
                            onClick={() =>
                              handleAddCart(
                                item?.name,
